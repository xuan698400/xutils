package com.xuan.xutils.net.http.client.core;
...
import com.xuan.xutils.net.http.client.HttpClient;
import com.xuan.xutils.net.http.client.HttpRequest;
import com.xuan.xutils.net.http.client.HttpResponse;
