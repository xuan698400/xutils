package com.xuan.xutils.net.socket.server.nio;
...
import com.xuan.xutils.net.socket.server.core.SocketServerThreadFactory;
...
public class NioSocketServer implements SocketServer {
    ...
    private final Executor BOSS = new ThreadPoolExecutor(1, 1,
        ...
        new LinkedBlockingQueue<>(), new SocketServerThreadFactory("BOSS_THREAD"));

    private final Executor WORKER = new ThreadPoolExecutor(30, 30,
        1L, TimeUnit.MILLISECONDS,
        new LinkedBlockingQueue<>(), new SocketServerThreadFactory("WORKER_THREAD"));
