...
public interface ListTaskExecutor<T, R> {
     ...
     */
    ListTaskResult<R> execute(List<T> originList, ListTaskCallable<T, R> callable, ListTaskConfig config)
     ...
     * @throws ListTaskException 用户需要自己处理异常
     */
    List<R> execute(List<T> originList, ListTaskCallable<T, R> callable) throws ListTaskException;
     ...
     * @throws ListTaskException 用户需要自己处理异常
     */
    List<R> execute(List<T> originList, ListTaskCallable<T, R> callable, int subOriginListSize)
        throws ListTaskException;
