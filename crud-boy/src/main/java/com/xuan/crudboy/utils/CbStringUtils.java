...
public class CbStringUtils {
    ...
    public static String defaultIfEmpty(String str, String defaultStr) {
        return CbStringUtils.isEmpty(str) ? defaultStr : str;
    }
    ...
    public static String join(List<String> strList, String sp) {
        if (CbCollectionUtils.isEmpty(strList)) {
            return "";
        }
    ...
    public static List<String> split(String str, String sp) {
        if (CbStringUtils.isEmpty(str)) {
            return new ArrayList<>();
        }
        String[] items = str.split(sp);
        List<String> list = new ArrayList<>();
        for (String s : items) {
            if (CbStringUtils.isNotEmpty(s)) {
                list.add(s);
            }
        }
        return list;
    ...
    public static List<String> split(String str) {
        return CbStringUtils.split(str, ",");
    }
