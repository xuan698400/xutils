...
import com.xuan.xutils.lock.impl.db.DbNonReentrantLock;
import com.xuan.xutils.lock.impl.db.DbReentrantLock;
...
public class LockTest extends BaseDbTest {
    ...
    private DistributedLock reentrantLock;
    private DistributedLock nonReentrantLock;
    ...
    private void testCount(DistributedLock lock, String lockName) {
    ...
    private void test(DistributedLock lock, String lockName) {
